    ...
    pub mod icp {
        ...
        pub mod cli_multiply {
            ...
            pub mod lib {
                ...
                #[doc(hidden)]
                macro_rules! __export_icp_cli_multiply_lib_0_0_1_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "icp:cli-multiply/lib@0.0.1#multiply")] unsafe extern "C" fn
                ...
                #[doc(hidden)]
                pub(crate) use __export_icp_cli_multiply_lib_0_0_1_cabi;
            }
        }
    }
}
...
macro_rules! __export_extension_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::icp::cli_multiply::lib::__export_icp_cli_multiply_lib_0_0_1_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::icp::cli_multiply::lib);
        $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:icp:cli-multiply@0.0.1:extension:encoded world"
)]
#[doc(hidden)]
...
\x01@\x02\x01ay\x01by\0y\x04\0\x08multiply\x01\0\x04\0\x1aicp:cli-multiply/lib@0\
.0.1\x05\x01\x01B\x05\x01@\0\0s\x04\0\x04spec\x01\0\x01ps\x01@\x01\x04args\x01\0\
}\x04\0\x03run\x01\x02\x04\0\x11icp:cli/cli@0.0.1\x05\x02\x04\0\x20icp:cli-multi\
ply/extension@0.0.1\x04\0\x0b\x0f\x01\0\x09extension\x03\0\0\0G\x09producers\x01\
