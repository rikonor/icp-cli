    ...
    pub mod local {
            ...
            pub mod cli {
                ...
                macro_rules! __export_local_extension_cli_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "local:extension/cli#spec")] unsafe extern "C" fn export_spec()
                        -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_spec_cabi::<$ty > () } } #[unsafe (export_name =
                        ...
                        #[unsafe (export_name = "local:extension/cli#run")] unsafe extern
        ...
        pub mod minimal {
            ...
            pub mod lib {
                ...
                #[doc(hidden)]
                macro_rules! __export_local_minimal_lib_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "local:minimal/lib#ping")] unsafe extern "C" fn export_ping() ->
                        * mut u8 { unsafe { $($path_to_types)*:: _export_ping_cabi::<$ty
                        > () } } #[unsafe (export_name =
                        "cabi_post_local:minimal/lib#ping")] unsafe extern "C" fn
                        _post_return_ping(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_ping::<$ty > (arg0) } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_local_minimal_lib_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_root_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        $($path_to_types_root)*::
        exports::local::minimal::lib::__export_local_minimal_lib_cabi!($ty with_types_in
        $($path_to_types_root)*:: exports::local::minimal::lib);
    };
}
#[doc(inline)]
...
A\x06\x01B\x02\x01@\x01\x01ss\x01\0\x04\0\x05print\x01\0\x03\0\x0flocal:host/mis\
c\x05\0\x01B\x05\x01@\0\0s\x04\0\x04spec\x01\0\x01ps\x01@\x01\x04args\x01\0}\x04\
\0\x03run\x01\x02\x04\0\x13local:extension/cli\x05\x01\x01B\x02\x01@\0\0s\x04\0\x04\
ping\x01\0\x04\0\x11local:minimal/lib\x05\x02\x04\0\x13root:component/root\x04\0\
\x0b\x0a\x01\0\x04root\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-co\
