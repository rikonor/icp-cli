        ...
        pub mod lib {
            ...
            pub fn add(a: u32, b: u32) -> u32 {
                unsafe {
                    ...
                    #[link(wasm_import_module = "local:add/lib")]
                    extern "C" {
                        #[link_name = "add"]
        ...
        pub mod multiply {
            ...
            pub mod lib {
                ...
                macro_rules! __export_local_multiply_lib_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name = "local:multiply/lib#multiply"]
                        unsafe extern "C" fn export_multiply(arg0 : i32, arg1 : i32,) ->
                        i32 { $($path_to_types)*:: _export_multiply_cabi::<$ty > (arg0,
                        arg1) } };
                    };
                }
                #[doc(hidden)]
...
\x01@\x02\x01ay\x01by\0y\x04\0\x03add\x01\0\x03\0\x0dlocal:add/lib\x05\x01\x01B\x05\
\x01@\0\0s\x04\0\x04spec\x01\0\x01ps\x01@\x01\x04args\x01\0}\x04\0\x03run\x01\x02\
\x04\0\x13local:extension/cli\x05\x02\x01B\x02\x01@\x02\x01ay\x01by\0y\x04\0\x08\
multiply\x01\0\x04\0\x12local:multiply/lib\x05\x03\x04\0\x13root:component/root\x04\
