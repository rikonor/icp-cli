    ...
    pub mod local {
        ...
        pub mod multiply {
            ...
            pub mod lib {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_multiply_cabi<T: Guest>(
                    arg0: i32,
                    arg1: i32,
                ) -> i32 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::multiply(arg0 as u32, arg1 as u32);
                    _rt::as_i32(result0)
                }
                pub trait Guest {
                ...
                #[doc(hidden)]
                macro_rules! __export_local_multiply_lib_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "local:multiply/lib#multiply")] unsafe extern "C" fn
                        export_multiply(arg0 : i32, arg1 : i32,) -> i32 { unsafe {
                        $($path_to_types)*:: _export_multiply_cabi::<$ty > (arg0, arg1) }
                        } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_local_multiply_lib_cabi;
            }
        }
    }
}
...
macro_rules! __export_root_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        $($path_to_types_root)*::
        exports::local::multiply::lib::__export_local_multiply_lib_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::local::multiply::lib);
    };
}
#[doc(inline)]
...
\x04\0\x13local:extension/cli\x05\x01\x01B\x02\x01@\x02\x01ay\x01by\0y\x04\0\x08\
multiply\x01\0\x04\0\x12local:multiply/lib\x05\x02\x04\0\x13root:component/root\x04\
\0\x0b\x0a\x01\0\x04root\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-\
