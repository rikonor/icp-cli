    ...
    pub mod icp {
        ...
        pub mod cli_project {
            ...
            pub mod lib {
                ...
                #[doc(hidden)]
                macro_rules! __export_icp_cli_project_lib_0_0_1_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "icp:cli-project/lib@0.0.1#create")] unsafe extern "C" fn
                        export_create() -> i32 { unsafe { $($path_to_types)*::
                        _export_create_cabi::<$ty > () } } };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_icp_cli_project_lib_0_0_1_cabi;
            }
        }
    }
}
...
macro_rules! __export_extension_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::icp::cli_project::lib::__export_icp_cli_project_lib_0_0_1_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::icp::cli_project::lib);
        $($path_to_types_root)*::
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:icp:cli-project@0.0.1:extension:encoded world"
)]
#[doc(hidden)]
...
\x01@\0\0y\x04\0\x06create\x01\0\x04\0\x19icp:cli-project/lib@0.0.1\x05\x01\x01B\
\x05\x01@\0\0s\x04\0\x04spec\x01\0\x01ps\x01@\x01\x04args\x01\0}\x04\0\x03run\x01\
\x02\x04\0\x11icp:cli/cli@0.0.1\x05\x02\x04\0\x1ficp:cli-project/extension@0.0.1\
\x04\0\x0b\x0f\x01\0\x09extension\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\
