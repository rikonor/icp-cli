        ...
        pub mod lib {
            ...
            pub fn build_canister(canister_dir: &str) -> Result<(), _rt::String> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "icp:build/lib@0.2.0")]
                    unsafe extern "C" {
    ...
    pub mod icp {
        ...
        pub mod project {
            ...
            pub mod lib {
                ...
                #[doc(hidden)]
                macro_rules! __export_icp_project_lib_0_4_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "icp:project/lib@0.4.0#list-canisters")] unsafe extern "C" fn
                        export_list_canisters() -> * mut u8 { unsafe {
                        $($path_to_types)*:: _export_list_canisters_cabi::<$ty > () } }
                        #[unsafe (export_name =
                        "cabi_post_icp:project/lib@0.4.0#list-canisters")] unsafe extern
                ...
                #[doc(hidden)]
                pub(crate) use __export_icp_project_lib_0_4_0_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_extension_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::icp::project::lib::__export_icp_project_lib_0_4_0_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:icp:project@0.4.0:extension:encoded world"
)]
#[doc(hidden)]
...
\x01\x01\x03\0\x13icp:build/lib@0.2.0\x05\0\x01B\x06\x01@\x01\x01ss\x01\0\x04\0\x05\
...
@\0\0\x03\x04\0\x0elist-canisters\x01\x04\x04\0\x15icp:project/lib@0.4.0\x05\x03\
\x01B\x05\x01@\0\0s\x04\0\x04spec\x01\0\x01ps\x01@\x01\x04args\x01\0}\x04\0\x03r\
un\x01\x02\x04\0\x11icp:cli/cli@0.2.0\x05\x04\x04\0\x1bicp:project/extension@0.4\
