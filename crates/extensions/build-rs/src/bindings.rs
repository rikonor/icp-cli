...
rs\0\0\x04\0\x0ebuild-canister\x01\x01\x04\0\x1bicp:build-rs/canister-build\x05\x04\
...
\0\x03run\x01\x02\x04\0\x11icp:cli/cli@0.3.2\x05\x06\x04\0\x16icp:build-rs/exten\
