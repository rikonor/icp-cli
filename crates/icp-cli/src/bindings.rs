...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:icp:cli@0.0.1:extension:encoded world"
)]
#[doc(hidden)]
...
\x01\x01\x01@\0\0w\x04\0\x04time\x01\x02\x03\0\x12icp:cli/misc@0.0.1\x05\0\x01B\x05\
\x01@\0\0s\x04\0\x04spec\x01\0\x01ps\x01@\x01\x04args\x01\0}\x04\0\x03run\x01\x02\
\x04\0\x11icp:cli/cli@0.0.1\x05\x01\x04\0\x17icp:cli/extension@0.0.1\x04\0\x0b\x0f\
